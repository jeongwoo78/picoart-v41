...
const fallbackPrompts = {
  ancient: {
    name: '그리스·로마',
    prompt: 'Ancient Greek Parthenon temple polychromy style - historically accurate painted marble sculpture: FIRST AND FOREMOST a white marble three-dimensional sculpture with smooth stone surface sculptural volume classical proportions and idealized Greek beauty, THEN painted color details applied on the marble. Painted EYES with colored irises blue green or brown and dark pupils. Painted LIPS in soft pink or rose color. Painted HAIR in black brown or gold colors. Painted CLOTHING togas and drapery in bright red blue yellow or green. The base material remains clearly visible as white marble stone with painted accents on top, NOT a fully painted surface, maintain marble texture and sculptural three-dimensional form, light bright background, classical Greek temple sculpture aesthetic like Parthenon sculptures originally appeared, unified composition, NOT photographic preserve facial identity, ancient Greek Parthenon polychromy masterpiece'
  },
