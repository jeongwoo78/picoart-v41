...
const fallbackPrompts = {
  ancient: {
    name: '그리스·로마',
    prompt: 'Ancient Greek polychrome sculpture - THREE-DIMENSIONAL marble statue with selective BRIGHT PAINT: maintain sculptural volume and depth, white marble base showing through in some areas, but CRITICAL PAINTED FEATURES: EYES must have PAINTED IRISES in bright blue green or brown colors with visible pupils NOT blank white eyes, CLOTHING and DRAPERY painted in VIVID COLORS including bright reds deep blues golden yellows emerald greens NOT plain stone, HAIR painted in rich colors black brown or gold, LIPS painted in soft pink or red, skin can remain pale marble or slightly tinted peachy, the sculpture retains full three-dimensional sculptural form and depth NOT flat, classical Greek idealized proportions, clear sculptural contours and volume, painted details add life to the marble form especially in eyes and garments, light bright background, imagine a Greek temple statue with strategically painted features that bring it to life, unified composition, NOT photographic preserve facial identity, ancient Greek polychrome sculpture quality - three-dimensional form with painted accents especially eyes and clothing'
  },
