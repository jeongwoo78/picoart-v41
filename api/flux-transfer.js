...
const fallbackPrompts = {
  ancient: {
    name: '그리스·로마',
    prompt: 'Ancient Greek art PAINTING depicting Parthenon temple figures - this is a PAINTED IMAGE not actual sculpture: render subjects in classical Greek sculptural poses and forms with idealized proportions BUT painted on canvas with VISIBLE COLORS. Subject has sculptural three-dimensional appearance but made with PAINT showing COLORED EYES with blue green or brown irises and dark pupils, COLORED HAIR in black brown or golden tones, COLORED LIPS in pink or rose, COLORED CLOTHING in bright reds blues yellows greens painted on draped fabric. Pale marble-like skin tone painted with warm cream and ivory colors. Classical Greek aesthetic but rendered as a PAINTING with brushwork and pigments NOT actual stone. Light neutral background painted in soft tones. Ancient Greek polychromy aesthetic recreated through painting technique, showing how temple sculptures looked with original paint. Unified composition, NOT photographic preserve facial identity, Neoclassical academic painting of Greek sculpture with visible paint colors masterpiece quality'
  },
