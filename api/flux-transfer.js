...
const fallbackPrompts = {
  ancient: {
    name: '그리스·로마',
    prompt: 'Ancient Greek POLYCHROME PAINTED sculpture - CRITICAL: statue MUST be PAINTED with BRIGHT COLORS, NOT plain white marble. Sculptural marble form as base structure, but ENTIRELY COVERED with vivid paint: COLORED SKIN painted in warm peachy flesh tones with rosy cheeks NOT white, BRIGHTLY COLORED CLOTHING painted in pure vivid reds bright blues golden yellows emerald greens NOT stone color, PAINTED HAIR in deep black rich brown or shining gold NOT white, PAINTED DETAILS including patterns borders and decorations on garments, LIGHT BRIGHT BACKGROUND in pale cream or soft sky blue, CRITICAL REQUIREMENT: the entire sculpture must show VISIBLE PAINT COLORS like authentic ancient Greek polychromy, imagine freshly painted temple sculptures with all colors still vibrant and bright, cheerful luminous colorful appearance, historically accurate ancient Greek painted marble aesthetic where paint completely covers the stone, unified composition, NOT photographic preserve facial identity, ancient Greek polychrome sculpture masterpiece quality - NEVER plain white unpainted marble'
  },
